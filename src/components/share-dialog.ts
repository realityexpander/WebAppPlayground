...
export declare var ShareDialog: {
  prototype: ShareDialog;
  new(): ShareDialog;
};
...
class ShareDialogImpl extends LitElement implements ShareDialog {
  ...
  render() {
    ...
    let encodedDescription = encodeURIComponent(this.description);
    ...
    return html`
      ...
      >
        ...
        <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=${encodedDescription}&amp;url=${encodedUrl}" target="_blank" rel="noopener" aria-label="Twitter">
        ...
        <a class="resp-sharing-button__link" href="mailto:?subject=${encodedTitle}&amp;body=${encodedDescription}%20${encodedUrl}" target="_self" rel="noopener" aria-label="E-Mail">
        ...
        <a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=${encodedUrl}&amp;title=${encodedDescription}&amp;source=${encodedUrl}" target="_blank" rel="noopener" aria-label="LinkedIn">
